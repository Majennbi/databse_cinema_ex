...
GRANT ALTER,
SELECT
    ON CINEMA_MOVIE_VIEW TO 'cinema_admin1' @'localhost';
...
ALTER TABLE cinema RENAME COLUMN address TO adress;
...
ALTER TABLE session MODIFY COLUMN date DATE NOT NULL;
...
ALTER TABLE user ADD role JSON NOT NULL;
